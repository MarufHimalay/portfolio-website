...
const Header = () => {
    return (
        <div style={{ backgroundColor: "#222222" }}>
            <Container >
                <div style={{ height: "600px" }} className="row   pt-5 align-items-center">
                    <div className="  col-md-6 justify-content-center">
                        <div >
                            <p style={{ color: "#EE6B4D", fontWeight: "700" }} className="title">HI THERE!</p>
                            <h1 style={{ color: "#E6F1FF", fontWeight: "700" }}><span style={{ color: "#EE6B4D" }}>I'm</span> MOIN UDDIN MARUF</h1>
                            <h2 style={{ color: "#EE6B4D" }}>Frontend Developer</h2>
                            <br />
                    ...
                    <div className="col-md-6 d-flex justify-content-center">
                        <img style={{ width: "70%" }} src={myPic} alt="" srcset="" />
                    </div>
                </div>
            </Container>
        </div>
